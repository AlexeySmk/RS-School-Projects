...
let pet2 = {
    "name": "Sophia",
    "img": "assets/images/pets-sophia-500.png",
    "type": "Dog",
    "breed": "Shih tzu",
...
let popups = document.querySelectorAll("body > section.our-friends-section > article > div > div.slider-item-wrapper > .slider-item > button")
...
popups.forEach(item => {
    item.addEventListener("click", function(e) {
        ...
        if (e.target.className === "slider-item-btn pop1") {
            paste(pet5);
            deleteNodes(childNodes);
            document.querySelector(".popup-wrapper").style.display = "flex";
            document.querySelector("body").style.overflow = "hidden";
        }
        if (e.target.className === "slider-item-btn pop2") {
            paste(pet1);
            deleteNodes(childNodes);
            document.querySelector(".popup-wrapper").style.display = "flex";
            document.querySelector("body").style.overflow = "hidden";
        }
        if (e.target.className === "slider-item-btn pop3") {
            paste(pet3);
            deleteNodes(childNodes);
            document.querySelector(".popup-wrapper").style.display = "flex";
            document.querySelector("body").style.overflow = "hidden";
